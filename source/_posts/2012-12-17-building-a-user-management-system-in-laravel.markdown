...
![project structure](/images/posts/building_user_management_using_laravel/project_structure.jpg)
...
Note that were using blade in here so instead of the single curly brace pair ```{}```. 
